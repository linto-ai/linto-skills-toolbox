...
const ParserNlu = require('../parser/nluParser')
const uriGetApplication = '/rest/admin/dump/sentences/'
...
class PopulateNlu {
  ...
  inject(tockData, applicationName, filePath) {
    this.parser.process(applicationName, filePath)
      .then((parsedJson) => {
